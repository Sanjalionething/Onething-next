import "../styles/pages/ux-audit.scss";
      ...
      <div className="container">
        <div className="heading-wrapper">
          ...
          <div className="banner-wrapper-sub">
            <figure>
              <img loading="lazy" src="/assets/img/ux-audit/audit-banner.webp" className="banner page-banner" alt="" />
            </figure>
          </div>
    ...
    <section className="ux-audit-services-wrapper blur-overlay">
      <div className="div-wrap">
        ...
        <div className="services-audit-banner-content">
          ...
          <figure>
            <img loading="lazy" src="/assets/img/ux-audit/audit-services.webp" className="banner section-banner" alt="" />
          </figure>
        </div>
      </div>
    </section>
            ...
            <div className="content">
              ...
              <div className="cta-wrapper">
                <a className="bttn bttn-secondary" href="/contact">
                  ...
                  <img loading="lazy" src="/assets/img/global/grad-arrow.svg" className="icon-arrow icon" alt="" />
                </a>
              </div>
            </div>
