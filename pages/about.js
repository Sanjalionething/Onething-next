...
const About = () => {
  ...
  useEffect(() => {
    ...
    // Use document.querySelector inside useEffect
      const cursorMedia = document.querySelector(".mf-cursor-media");

      if (cursorMedia) {
        cursorMedia.style.width = "150px";
        cursorMedia.style.height = "150px";
        cursorMedia.style.margin = "-70px 0 0 -70px";
      }
  ...
  const teamSliderPrev = () => {
    ...
    // useEffect(()=>{
    //   if(typeof window!==undefined){
    //     document.querySelector('.teams_slider').slick('unslick');
    //     document.querySelector('.teams_slider').slick(teamSettings);
    //   }
    // })
  useEffect(() => {
  ...
  return (
    ...
    {!loading && (
      ...
      <figure>
      <img loading="lazy"
      src='/assets/img/about/team/divanshu.webp'
      className="img-fluid"
      ...
      <figure>
      <img loading="lazy"
      src='/assets/img/about/team/manik.webp'
      className="img-fluid"
      alt="Manik Arora"
      />
      <figcaption>
      ...
      <div className="teams_card">
      <figure>
      <img loading="lazy" src='/assets/img/about/team/hari.webp' className="img-fluid" alt="Manik Arora"
      />
      <figcaption>
      <h5>
      Harikumaran
      ...
      <figure>
      <img loading="lazy"
      src='/assets/img/about/team/aishwarya.webp'
      className="img-fluid"
      alt="Aishwarya"
      />
      <figcaption>
      ...
      <figure>
      <img loading="lazy"
      src='/assets/img/about/team/shaurya.webp'
      className="img-fluid"
      alt="Shaurya Chabbra"
      />
      <figcaption>
      ...
      <div className="image-slider-overlay-bttn slider-half left-slider-bttn" data-cursor-img='/assets/img/global/culture-hover-left.svg' onClick={teamSliderPrev}
      ></div>
      <div className="image-slider-overlay-bttn slider-half right-slider-bttn" data-cursor-img='/assets/img/global/culture-hover-right.svg' onClick={teamSliderNext}
      ></div>
      </div>
      </div>
      </div>
