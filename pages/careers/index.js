...
export default function Careers({ jobsState, fetchJobs }) {
  ...
  return loading && !jobList ? (
    ...
    <figure>
    <img loading="lazy" src="/assets/img/careers/5.webp" className="img-fluid" alt="" />
    <figcaption>
    <p>Follow us</p>
    <ul>
    <li>
    ...
    >
    <img loading="lazy" src="/assets/img/careers/one-o-one.webp" className="img-fluid" alt="" />
    <figcaption>
    <button
    ...
    >
    <img loading="lazy" src="/assets/img/careers/one-star.webp" className="img-fluid" alt="" />
    <figcaption>
    <button
    className="toggle-indicator"
    onClick={() => setOneOoneTrigger(!isOneOoneTriggered)}
    ...
    >
    <img loading="lazy" src="/assets/img/careers/one-up.webp" className="img-fluid" alt="" />
    <figcaption>
    <button
    className="toggle-indicator"
    onClick={() => setOneOoneTrigger(!isOneOoneTriggered)}
    ...
    >
    <img loading="lazy" src="/assets/img/careers/super-ones.webp" className="img-fluid" alt="" />
    <figcaption>
    <button
    className="toggle-indicator"
    onClick={() => setOneOoneTrigger(!isOneOoneTriggered)}
