...
import { fetchJobs } from "../../essentials/redux/actions/";

// const fetchJobs = () => {
//   fetchJobs: () => dispatch(fetchJobs()),
// };

export default function Careers({ jobsState, fetchJobs }) {
  ...
  useEffect(() => {
    if (typeof window !== undefined) {
      ...
      window.addEventListener("scroll", function () {
        ...
        let third_grad_right = document.getElementById("third_grad_right");
    ...
    <div className="careers-page-wrapper page-wrapper">
              ...
              <div>
                <p className="banner-text-wrapper">
                  <span className="banner-text-anim banner-description">
                    Wonders can happen when different people grow in unison.{" "}
                    <br />
      ...
      <section className="banner-image-section blur-overlay">
        <div className="div-wrap left_container">
          <figure>
            <img
              loading="lazy"
              src="/assets/img/careers/careers-banner.webp"
              className="img-fluid"
              alt="Careers Banner"
            />
          </figure>
        ...
        <div className="container">
          ...
          <div className="div-wrap">
              ...
              <div className="accordion-content-area service-accordian">
                <Accordion flush>
                  <Accordion.Item eventKey="0">
                    ...
                    <Accordion.Body>
                      <p>
                        Virtual workshops hosted by industry experts, on design,
                        and everything surrounding! Bolster your understanding
                        with veterans of the field.
                      </p>
                    </Accordion.Body>
                  </Accordion.Item>
                  <Accordion.Item eventKey="1">
                    ...
                    <Accordion.Body>
                      <p>
                        Work alongside some of the brightest design talent in
                        the nation, crafting experiences through mutual learning
                        and collaboration.
                      </p>
                    </Accordion.Body>
                  </Accordion.Item>
                  <Accordion.Item eventKey="2">
                    ...
                    <Accordion.Body>
                      <p>
                        ...
                        constantly looking for ways to bring the team together,
                        and craft lifelong memories.
                      </p>
                    </Accordion.Body>
                  </Accordion.Item>
                  <Accordion.Item eventKey="3">
                    ...
                    <Accordion.Body>
                      <p>
                        Go beyond as a designer, having your work reviewed by
                        qualified peers, getting a second opinion on theories
                        you want to test, or designs you love!
                      </p>
                    </Accordion.Body>
                  </Accordion.Item>
                </Accordion>
            ...
            <div className="gallery-career">
              <img
                loading="lazy"
                src="/assets/img/careers/1.webp"
                className="img-fluid first-career"
                alt=""
              />
              <img
                loading="lazy"
                src="/assets/img/careers/3.webp"
                className="img-fluid second-career"
                alt=""
              />
              <img
                loading="lazy"
                src="/assets/img/careers/2.webp"
      ...
      <section className="team-testimony-section blur-overlay">
        <div className="div-wrap">
          <div className="container">
            <div
              id="fourth_grad_right"
              className="grad-img grad_img3 grad type-2 small"
            ></div>
            <div
              id="fifth_grad_left"
            ...
            <div className="team-content">
              <div className="testimony_content left_container">
                <figure>
                  <img
                    loading="lazy"
                    src="/assets/img/about/team/ravina.webp"
                    className="img-fluid team-member"
                    alt=""
                  />
                  <figcaption>
                    <p>
                      Onething has people with such diverse and unique mindsets
                      that there’s so much to learn from every individual, be it
                      a team lead or an intern. It’s a culture where learning
                      goes beyond work, where we learn how to live.
                    </p>
                    <h6 className="fs-18">
            ...
            >
              <div>
                <div className="impact_card award_img1">
                  <h6>Wellness</h6>
                  <p>
                    We care about the physical & mental well-being of our people
                    and offer policies that reflect immense care and compassion.
                  </p>
                </div>
              </div>
              <div>
                <div className="impact_card award_img2">
                  ...
                  <p>
                    We believe, giving people full accountability for what they
                    do is essential for a sustainable working environment.
                  </p>
                </div>
              </div>
              <div>
              ...
              <div>
                <div className="impact_card award_img1">
                  <h6>Break time</h6>
                  <p>
                    Work hard and play harder maybe a cliché, but we function
                    completely by this saying. From crazy off-sites to warm
                    parties, we leave no chance to get together.
                  </p>
                </div>
              </div>
            </Slider>
            ...
            >
              <Tab eventKey="one-o-one" title="One o one">
                ...
                >
                  <img
                    loading="lazy"
                    src="/assets/img/careers/one-o-one.webp"
                    className="img-fluid"
                    alt=""
                  />
                  <figcaption>
                    ...
                    <div className="brief">
                      <p className="fs-18">
                        ...
                        create an honest, judgment-free platform for everyone
                        within Onething to share their views.
                      </p>
                    </div>
                  </figcaption>
                </figure>
              ...
              <Tab eventKey="one-stars" title="One stars">
                ...
                >
                  <img
                    loading="lazy"
                    src="/assets/img/careers/one-star.webp"
                    className="img-fluid"
                    alt=""
                  />
                  <figcaption>
                    ...
                    <div className="brief">
                      <p className="fs-18">
                        A peer-rating system, allowing the people of Onething to
                        shout-out and show their appreciation for their
                        teammates, upon receiving enough stars, the teammate
                        receives a gift!
                      </p>
                    </div>
                  </figcaption>
              ...
              <Tab eventKey="huddles" title="One Up">
                ...
                >
                  <img
                    loading="lazy"
                    src="/assets/img/careers/one-up.webp"
                    className="img-fluid"
                    alt=""
                  />
                  <figcaption>
                    ...
                    <div className="brief">
                      <p className="fs-18">
                        Our folks get full monetary support if they wish to take
                        up any skill building course, once in every 6 months.
                        Because we believe the learning never stops!
                      </p>
                    </div>
                  </figcaption>
                </figure>
              ...
              <Tab eventKey="super-ones" title="Super Ones">
                ...
                >
                  <img
                    loading="lazy"
                    src="/assets/img/careers/super-ones.webp"
                    className="img-fluid"
                    alt=""
                  />
                  <figcaption>
                    ...
                    <div className="brief">
                      <p className="fs-18">
                        A quarterly appreciation system, allowing senior members
                        of the team to vote on outstanding performers and
                        excellent displays in the past quarter, the cherry on
                        top? All Superones receive a gift!
                      </p>
                    </div>
                  </figcaption>
                </figure>
                ...
                <div className="job-row">
                  ...
                  <div className="job-col col-main">
                    <Tab.Content>
                      ...
                      <Tab.Pane eventKey="development">Development</Tab.Pane>
                    </Tab.Content>
                  </div>
                </div>
              </Tab.Container>
