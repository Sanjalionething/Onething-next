import "../styles/pages/bangalore-space.scss";
...
export default function BangaloreSpace() {
  return (
    ...
    <img loading="lazy" src="/assets/img/about/about_banner.webp" alt=""/>
    </figure>
    </div>
    </div>
    </section>
    ...
    <figure>
    <img loading="lazy" src="/assets/img/services/research-one-y.webp" className="img-fluid" alt="UI UX Design Services" />
    </figure>
    </div>
    </div>
    </div>
    ...
    <figure class="dwp">
    <img loading="lazy" src="/assets/img/ods/dwp.webp" className="icon icon-submit"alt=""/>
    </figure>
    </div>
    </div>
    </section>
