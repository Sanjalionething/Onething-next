...
function Footer({}) {
  ...
  return (
    <>
      {/* {
     router.pathname==='/contact' || router.pathname==='/industries'?"":
      ...
      <img loading="lazy"
      src='/assets/img/global/grad-arrow.svg'
            ...
            <div className="col-sm-4">
              <div className="ph-single-col">
                ...
                <div className="footer-clutch">
                  ...
                  <img
                    loading="lazy"
                    src="/assets/img/svg/Clutch.webp"
                    alt="Clutch Logo"
                  />
                </div>
              </div>
                ...
                <div className="col-sm-9">
                  ...
                  <div className="write--us">
                    ...
                    <div className="mails-sub">
                      <p>
                        <span className="sub-sub">For business</span>
                        <a href="mailto:sayhello@onething.design">
                          sayhello@onething.design
                        </a>
                      </p>
                      <p>
                        <span className="sub-sub">For careers</span>
                        <a href="mailto:people@onething.design">
            ...
            <div className="addresses-grid">
              <div className="address-main">
                <div className="ad-loc">
                  <img
                    loading="lazy"
                    src="/assets/img/icons/gurgaon-footer.svg"
                    className="icon icon-submit"
                    alt=""
                  />
              ...
              <a href="/ui-ux-design-company-in-bangalore">
                <div className="address-main">
                  <div className="ad-loc">
                    <img
                      loading="lazy"
                      src="/assets/img/icons/bangalore-footer.svg"
                      className="icon icon-submit"
                      alt=""
                    />
              ...
              <div className="address-main">
                <div className="ad-loc">
                  <a
                    href="https://goo.gl/maps/sz7FRsb9Eu9kj1ja8"
                    target="_blank"
                  >
                    <img
                      loading="lazy"
                      src="/assets/img/icons/usa-footer.svg"
                      width={50}
                      height={50}
                      className="icon icon-submit"
                      alt=""
...
//   await sendSubsForm=(formData) => dispatch(sendSubsForm(formData))
