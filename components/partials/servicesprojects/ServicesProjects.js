                  ...
                  <div className="project-thumbnail one">
                    <a href="projects/energy/statiq/">
                      <div
                        ...
                        style={{
                          backgroundImage: `url("/assets/img/home/statiq-home-thumbnail.webp")`,
                        }}
                      ></div>
                    </a>
                  </div>
                  <div className="project-thumbnail two">
                    <a href="projects/iot/noise/">
                      <div
                        className="slide tileImage"
                        style={{
                          backgroundImage: `url("/assets/img/home/noise-home-thumbnail.webp")`,
                        }}
                      ></div>
                    </a>
                  </div>
                  <div className="project-thumbnail three">
                    <a href="projects/automotive/nuego/">
                      <div
                        className="slide tileImage"
                        style={{
                          backgroundImage: `url("/assets/img/projects/nuego.webp")`,
                        }}
                      ></div>
                    </a>
                  </div>
                  <div className="project-thumbnail four">
                    <a href="projects/enterprise/airtel/">
                      <div
                        className="slide tileImage"
                        style={{
                          backgroundImage: `url("/assets/img/home/airtel-home-thumbnail.webp")`,
                        }}
                      ></div>
                    </a>
                  </div>
                ...
                <Slider {...settings}>
                  <div>
                    <figure className="project-thumbnail-phone">
                      <img
                        loading="lazy"
                        src="/assets/img/home/statiq-home-thumbnail.webp"
                        alt=""
                      />
                      <div className="text-intro one">
                        <h5>
                  ...
                  <div>
                    <figure className="project-thumbnail-phone">
                      <img
                        loading="lazy"
                        src="/assets/img/home/noise-home-thumbnail.webp"
                        alt=""
                      />
                      <div className="text-intro one">
                        <h5>
                  ...
                  <div>
                    <figure className="project-thumbnail-phone">
                      <img
                        loading="lazy"
                        src="/assets/img/projects/nuego.webp"
                        alt=""
                      />
                      <div className="text-intro one">
                        <h5>
                  ...
                  <div>
                    <figure className="project-thumbnail-phone">
                      <img
                        loading="lazy"
                        src="/assets/img/home/airtel-home-thumbnail.webp"
                        alt=""
                      />
                      <div className="text-intro one">
                        <h5>
