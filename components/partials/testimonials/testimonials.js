            ...
            <div className="container">
                <div className="row m-0">
                    <div className="col-md-4">
                        ...
                        <div>
                                <figure>
                                    <img loading="lazy" src="/assets/img/global/testimonial-two.webp" className="img-fluid" alt="Testimonial Onething" />
                                </figure>
                            </div>
                            ...
                            <div>
                                <figure>
                                    <img loading="lazy" src="/assets/img/global/testimonial-three.webp" className="img-fluid" alt="Testimonial Onething" />
                                </figure>
                            </div>
                            <div>
                                <figure>
                                    <img loading="lazy" src="/assets/img/global/testimonial-one.webp" className="img-fluid" alt="Testimonial Onething" />
                                </figure>
                            </div>
                        </Slider>
                    </div>
                    <div className="col-md-8">
                        ...
                        <ul className="list-unstyled d-flex custom_arrows">
                            <li className="prev" onClick={sliderPrev}>
                                <img loading="lazy" src="/assets/img/svg/left-arrow.svg" className="img-fluid" alt="Left Arrow" />
                            </li>
                            <li className="next" onClick="/assets/img/svg/left-arrow.svg">
                                <img loading="lazy" src="/assets/img/svg/right-arrow.svg" className="img-fluid" alt="Right Arrow" />
                            </li>
                        </ul>
                    </div>
                </div>
