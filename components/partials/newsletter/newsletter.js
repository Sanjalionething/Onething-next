          ...
          <div className="container">
            <div className="content-grid position-relative">
                  ...
                  <form onSubmit={handleFormSubmit}>
                    <div className="form-group">
                      <div className="position-relative input-wrapper">
                        ...
                        <p className="message-container success-msg">
                          {msg_status}
                        </p>
                      </div>
                    </div>
              ...
              <div className="visual-glance">
                <div
                  id="newsletter_grad_one"
                  className="grad mesh-gradient large gr-box1"
                ></div>
                <div
                  id="newsletter_grad_two"
