        ...
        <section className="related-blogs-main">
          <div className="div-wrap">
            <div className="container">
              <div id="grad_one_related_blogs" className="grad w small gr-box1"></div>
              <div id="grad_two_related_blogs" className="grad type-2 small gr-box2"></div>
                ...
                <div className="info-container">
                  <div className="accordion-info">
                    {relatedBlogs.slice(0, 3).map((blog, i) => {
                      return (
                        <a href={"/blogs/" + blog.slug + "/"} className="qodef-m-navigation" key={i}>
                          <div className="qodef-m-title-image-wrapper">
                            <div className="qode-title">
                              ...
                              <p className="blog-details">
                                <span className="author">{blog._embedded.author[0].name}</span>-
