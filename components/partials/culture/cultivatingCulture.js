          ...
          <div className="container">
            <div className="row no-gutter culture-intro">
              <div className="col-md-4">
                <div
                  id="thirdLast"
                  className="grad type-2-reverse large gr-box"
                ></div>
              </div>
              <div className="col-md-8">
                <div className="culture-heading">
                  <h2 className="section-heading">Cultivating culture</h2>
                  <p className="culture-brief">
                    We’re much more than a UI/UX design studio. It’s our
                    collective spirit, creativity, and strive for perfection
                    which define us. From cultivating bonds which stretch far
                    beyond the workplace, to sustainably giving back to the
                    community, we’re fostering something far greater than the
                    sum of our parts.
                  </p>
                </div>
              </div>
            ...
            <div className="no-gutter row slider-row">
              <div className="col-md-4">
                <div className="image-slider-wrap left-image-slider-wrap">
                    ...
                    <div>
                      <div className="reveal">
                        <figure className="slide-cell slick-culture-left reveal-image reveal-image-left">
                          <img
                            loading="lazy"
                            src={cultivatingCultureSmall1}
                            className="Culture : Onething"
                            alt=""
                          />
                        </figure>
                      </div>
                  ...
                  <div
                    className="image-slider-overlay-bttn left-slider-bttn"
              ...
              <div className="col-md-8">
                <div className="image-slider-wrap right-image-slider-wrap">
                  ...
                  <div
                    className="image-slider-overlay-bttn right-slider-bttn"
